...
<style lang="scss" scoped>
  ...
  .link::before {
    ...
    z-index: 2;
    inset: 0;
    border-inline: 1px solid var(--color-signal-soft);
    background:
      linear-gradient(
        135deg,
      ...
      linear-gradient(var(--color-signal-soft) 1px, transparent 1px),
      linear-gradient(90deg, var(--color-signal-soft) 1px, transparent 1px);
