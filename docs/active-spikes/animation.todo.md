...
- A18. READY FOR HUMAN QA: the homepage BLUF pill now carries a continuously rotating asymmetric star and is an explicit button disclosure control. Opening it explains “Bottom Line Up Front” as clarity-first, depth-on-demand working practice and provides jump links to Selected Work, Collaborators, Side Projects, and Latest Writing. The Testimonials section now exposes the `collaborators` anchor. Verify the copy, disclosure placement across the bespoke desktop/tablet/phone hero compositions, keyboard behavior, and whether the jump menu is useful enough to retain.
