...
- A7. QUEUED, DO NOT INTEGRATE YET: test the combined scroll cascade and second-letter pointer parallax on the actual homepage Selected Work heading after the remaining lab tuning is settled.
