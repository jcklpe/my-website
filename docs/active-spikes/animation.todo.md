...
- A5. SELECTED IN HUMAN QA 2026-08-12: writing archive rows use a one-time bottom-up slit entrance with a 140ms item stagger. Production implementation must coordinate normal page arrival and forward/reverse featured-media transitions; the lab approval settles the visual grammar, not that integration yet.
- A6. SELECTED IN HUMAN QA 2026-08-12: homepage testimonials use the lateral-wipe entrance with the lab's shared 140ms item stagger as the current approved timing. Production implementation remains pending; do not substitute the rejected center slit.
