...
- Human QA 2026-07-30: opacity, shade, and liveliness approved on the first look ("pretty much perfect"). Only change requested: cell scale 2–3× larger — bumped `CELL_SIZE` from 5px to 13px. Pending confirmation of the larger scale, then Done.
