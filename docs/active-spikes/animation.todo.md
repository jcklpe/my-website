...
**Current priority, set 2026-08-05 — START HERE IF YOU ARE PICKING THIS UP COLD.**
...
## Ready For Human QA
- (empty — the slit-slip arrows were confirmed working 2026-08-05; the archive-link bug found during that check is fixed and recorded in Done.)
