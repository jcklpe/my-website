...
- C. Review the generated 1200×630 default social-card candidate. It remains outside the repository and is not connected to page metadata; approval is required before it becomes the bundled fallback Open Graph image.
