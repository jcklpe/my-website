...
- **Testimonial motion and quotation grammar:** testimonials remain continuously present. Their header joins the selected pointer-proximity field; a large low-contrast Bodoni opening mark reinforces that the body is quoted speech; and the existing small blue striped marks become slow continuously travelling signal bars. This is a deliberately small ambient loop, disabled under reduced motion.
