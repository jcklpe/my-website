...
- **Text as moving material:** candidates included low-amplitude displacement ooze, animated masks, print-registration copies, variable-font axes, per-letter choreography, and purpose-built SVG glyphs. Human review narrowed the Selected Work accent itself to the irregular travelling flag, repaired mass-shedding metaballs, and a hybrid flag with shedding vector blobs. Preserve semantic text and confine procedural material to small display/accent regions.
