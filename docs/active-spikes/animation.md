...
- **Testimonial motion and quotation grammar:** testimonials remain continuously present. Their header joins the selected pointer-proximity field; a large low-contrast Bodoni opening mark reinforces that the body is quoted speech; and the CMS-selected texture may move as a shallow pointer-parallax plane. The ambient blue signal is under direct comparison: either the existing small striped marks travel continuously or the enlarged quotation mark itself carries the moving stripe material. Both are deliberately small ambient loops and freeze under reduced motion.
