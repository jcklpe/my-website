...
- **WCAG + SEO baseline** — complete. Pass-1 practical accessibility and metadata audit is done; durable rules are folded into `AGENTS.md` and `docs/visual-design.md`. Design branches inherit a clear accessibility and SEO contract. A later qualitative/design-theory follow-up can live in `docs/scratch/wcag-seo2.md`.
