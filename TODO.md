...
## In Progress
- Performance and optimization — return clipping, Lodestone title wrapping, and U5's settled-card work reduction have positive user QA as of 2026-09-16. The user now reports no normal-Chrome strobing and smoother port-3002 motion; full/half-width case-study endpoint checks and the Enzo writing regression round trip passed. Further smoothness work should measure speculative payload/renderer preparation overlapping navigation before changing scheduling. Transition choreography and parallax remain intact; no production improvement or deployment is claimed. Minimal continuation context lives at `docs/active-spikes/performance-optimization.todo.md` → “Fresh-Agent Handoff” and Checkpoint 33; conceptual scope remains in `docs/active-spikes/performance-optimization.md`.
