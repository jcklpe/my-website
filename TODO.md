...
## In Progress
- None currently active. Next candidate: promote the Animation spike from `docs/scratch/animations.md` (ambient motion / reaction-diffusion / slit-slip / Conway / featured-media transition-jank), which continues from brand-voice.
